 ...
 */
package org.datatree.dom.converters;
...
public class DataConverterRegistry extends AbstractConverterSet {
	...
	static {
		...
		try {
			Class.forName("org.datatree.dom.converters.BasicConverterSet");
		} catch (Exception ignored) {
		}

		// Load converters for MongoDB / BSON object types
		try {
			Class.forName("org.datatree.dom.converters.BsonConverterSet");
		} catch (Exception ignored) {
		}
	}
